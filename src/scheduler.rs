...
use bitcoin::{consensus::Encodable, psbt::PartiallySignedTransaction, Address, Script, TxOut};
use ln_types::P2PAddress;
use tonic_lnd::rpc::OpenChannelRequest;

use crate::{
    args::ArgError,
    lnd::{LndClient, LndError},
};
...
impl ScheduledPayJoin {
    ...
    pub fn wallet_amount(&self) -> bitcoin::Amount {
        self.wallet_amount
    }
...
impl Scheduler {
    ...
    pub async fn propose_payjoin(
        ...
        // TODO explain why we're doing what looks like a chinese firedrill OR remove it
        let proposal_psbt =
